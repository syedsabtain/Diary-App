                        ...
                        <div className="myform form ">
                            ...
                            <form onSubmit={handleSubmit(onSubmit)}>
                                <div className="form-group">
                                    <label>Name</label>
                                    <input type="text" ref={register({required:true,minLength:3, maxLength:20})}  name="name" className="form-control" id="name" aria-describedby="emailHelp" placeholder="Enter Name" />
                                ...
                                <div className="form-group">
                                    ...
                                    <input type="text" ref={register({required:true,minLength:4,maxLength:10})}
